/*
  ...
  - You are about to alter the column `depositlimit` on the `pokerstars` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
