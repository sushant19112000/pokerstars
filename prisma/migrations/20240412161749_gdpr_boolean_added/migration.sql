...
INSERT INTO "new_landingpage" ("campaignCode", "content", "data", "downloadpageurl", "formdata", "headerBackgroundColor", "id", "logoHeight", "logoSrc", "logoWidth", "optin", "template", "title", "url") SELECT "campaignCode", "content", "data", "downloadpageurl", "formdata", "headerBackgroundColor", "id", "logoHeight", "logoSrc", "logoWidth", "optin", "template", "title", "url" FROM "landingpage";
