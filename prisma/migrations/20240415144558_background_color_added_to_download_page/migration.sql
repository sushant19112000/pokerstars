...
CREATE TABLE "new_downloadpage" (
    ...
    "headerBackgroundColor" TEXT NOT NULL DEFAULT '#00b336',
...
INSERT INTO "new_downloadpage" ("campaignCode", "id", "imageHeight", "imageUrl", "imageWidth", "link", "logoHeight", "logoSrc", "logoWidth", "pdfSrc", "template", "title", "url") SELECT "campaignCode", "id", "imageHeight", "imageUrl", "imageWidth", "link", "logoHeight", "logoSrc", "logoWidth", "pdfSrc", "template", "title", "url" FROM "downloadpage";
