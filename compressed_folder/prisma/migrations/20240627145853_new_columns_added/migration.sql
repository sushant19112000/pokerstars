...
CREATE TABLE "new_landingpage" (
    ...
    "formTitle" TEXT NOT NULL DEFAULT 'Please fill out the form below to download.',
    "download" TEXT NOT NULL DEFAULT 'Download',
...
INSERT INTO "new_landingpage" ("campaignCode", "content", "data", "downloadpageurl", "formdata", "gdpr", "headerBackgroundColor", "id", "logoHeight", "logoSrc", "logoWidth", "optin", "template", "title", "url") SELECT "campaignCode", "content", "data", "downloadpageurl", "formdata", "gdpr", "headerBackgroundColor", "id", "logoHeight", "logoSrc", "logoWidth", "optin", "template", "title", "url" FROM "landingpage";
...
CREATE TABLE "new_mailer" (
    ...
    "campaignCode" TEXT NOT NULL,
    "content" TEXT NOT NULL DEFAULT 'Html Content',
    "headerBackgroundColor" TEXT NOT NULL DEFAULT '#e3653c',
    ...
    "unsubscribe" TEXT NOT NULL DEFAULT 'unsubscribe',
    "privacy" TEXT NOT NULL DEFAULT 'privacy',
    "template" TEXT NOT NULL DEFAULT 'JBW',
    "updateProfile" TEXT NOT NULL DEFAULT 'updateProfile',
    "html" TEXT NOT NULL DEFAULT '<div>Html</div>',
    "button" TEXT NOT NULL DEFAULT 'Download',
...
INSERT INTO "new_mailer" ("campaignCode", "content", "footer", "headerBackgroundColor", "id", "imageHeight", "imageUrl", "imageWidth", "landingpageurl", "logoHeight", "logoSrc", "logoWidth", "privacy", "template", "title", "unsubscribe", "updateProfile", "url") SELECT "campaignCode", "content", "footer", "headerBackgroundColor", "id", "imageHeight", "imageUrl", "imageWidth", "landingpageurl", "logoHeight", "logoSrc", "logoWidth", "privacy", "template", "title", "unsubscribe", "updateProfile", "url" FROM "mailer";
DROP TABLE "mailer";
