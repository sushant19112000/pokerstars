/*
  ...
  - Added the required column `privacy` to the `mailer` table without a default value. This is not possible if the table is not empty.
  - Added the required column `unsubscribe` to the `mailer` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updateProfile` to the `mailer` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_mailer" ("campaignCode", "content", "footer", "id", "imageHeight", "imageUrl", "imageWidth", "landingpageurl", "logoHeight", "logoSrc", "logoWidth", "title", "url") SELECT "campaignCode", "content", "footer", "id", "imageHeight", "imageUrl", "imageWidth", "landingpageurl", "logoHeight", "logoSrc", "logoWidth", "title", "url" FROM "mailer";
DROP TABLE "mailer";
