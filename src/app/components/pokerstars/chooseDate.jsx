    ...
    return (
        <>
            ...
            <div className="row justify-content-center pt-3">
                <div className="col-md-3">
                    <div>
                        <p style={{ fontSize: '25px', color: 'black', fontWeight: '900', fontFamily: 'Roboto' }}>Les aspects légaux...</p>
                    </div>

                    <div>
                        <p style={{ fontSize: '14px', fontFamily: 'Roboto', color: 'RGB(102, 102, 102)' }}>Nous avons besoin de votre date de naissance pour confirmer que vous avez plus de 18 ans.</p>
                    </div>

                    <div>
                        <span style={{ color: 'RGB(215, 0, 34)', fontFamily: 'Roboto', fontSize: '15px' }}>Date de naissance</span>
                    </div>
                    ...
                    <div className='mt-1'>
                        <input
                            ...
                            style={{ border: '1px solid black', height: '50px', borderRadius: '0' }}
                        />
                        {error && (
                            <span style={{ color: 'RGB(8, 155, 128)', fontSize: '14px', fontFamily: 'Roboto' }}>{error}</span>
                        )}
                    </div>
                    ...
                    <div className='mt-5 mb-5 text-center'>
                        <button
                            className='btn w-100'
                            style={{ borderRadius: '18px', color: 'white', fontWeight: '700', backgroundColor: '#02bd9c' }}
                            onClick={handleNext}
                        >
                            Créer un compte
                        </button>
