            ...
            <div style={{ backgroundColor: 'black' }}>
                ...
                <div className="row pt-3  justify-content-center">
                    <div className="col-md-3 text-center">
                        <picture>
                            <img className='img-fluid w-100' src='/pokerstars/welcome.e24dab14.jpg' />
                        </picture>

                        <div className='pt-2'>
                            <p style={{ fontWeight: '600', color: 'white', fontFamily: 'Roboto', fontSize: '16px' }}>Pays de résidence</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='pt-3'>
                <div className="row justify-content-center">
                    <div className="col-md-3 ">
                        <div>
                            <p style={{ fontSize: '25px', color: 'black', fontWeight: '900', fontFamily: 'Roboto' }}>Dans quel pays habitez-vous ?</p>
                        </div>

                        <div>
                            <p style={{ fontSize: '14px', fontFamily: 'Roboto', color: 'RGB(102, 102, 102)' }}>Nous l'utiliserons afin de nous assurer que vous utilisez la bonne version de PokerStars Sports pour votre pays.</p>
                        </div>
