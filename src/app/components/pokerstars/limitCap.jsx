    ...
    return (
        <>
            <div className="row justify-content-center" style={{ backgroundColor: 'black' }}>
                <div className="col-md-3" >
                    <div className='pt-2 pb-2 d-flex' >
                        ...
                        <div className=''>
                            <p style={{ fontWeight: '600', color: 'white', fontFamily: 'Roboto', fontSize: '16px' }}>Limites de jeu responsable</p>
            ...
            <div className="row justify-content-center pt-3" >
                <div className="col-md-3" >
                    <div>
                        <p style={{ fontSize: '25px', color: 'black', fontWeight: '900', fontFamily: 'Roboto' }}>Limite cumulée</p>
                    </div>

                    <div>
                        <p style={{ fontSize: '14px', fontFamily: 'Roboto', color: 'RGB(102, 102, 102)' }}>La limite de mises cumulées est un plafonnement des montants que vous pouvez dépenser aux jeux de poker en argent réel et aux paris sportifs.
                        </p>
                    </div>


                    <div>
                        <span style={{ color: 'RGB(215, 0, 34)', fontFamily: 'Roboto', fontSize: '15px' }}>Limite de mise sur sept jours au poker</span>

                    </div>

                    <div className='mt-1'>
                        <select className='form-select' defaultValue="France" onChange={((e) => setWeeklyLimit(e.target.value))}>
                    ...
                    <div className='mt-3'>
                        <span style={{ color: 'RGB(215, 0, 34)', fontFamily: 'Roboto', fontSize: '15px' }}>Limite de mises sur sept jours aux paris sportifs
                        </span>

                    </div>

                    <div className='mt-1'>
                        <select id="stateOfBirth" className="form-select" onChange={((e) => (setSevenLimit(e.target.value)))} data-testid="state-of-birth">
                            {weeklyLimits.map((limit, index) => (
                                <option key={index} value={limit}>
                                    {limit}
                                </option>
