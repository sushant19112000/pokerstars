        ...
        <>
            <div className="row justify-content-center" style={{ backgroundColor: 'black' }}>
                <div className="col-md-3" >
                    <div className='pt-2 pb-2 d-flex' >
                        ...
                        <div className=''>
                            <p style={{ fontWeight: '600', color: 'white', fontFamily: 'Roboto', fontSize: '16px' }}>Votre mot de passe</p>
            ...
            <div className="row justify-content-center pt-3" >
                <div className="col-md-3" >
                    ...
                    <div className='mt-1'>
                        <input onChange={((e) => setPassword(e.target.value))} className='form-control' style={{ border: '1px solid black', height: '50px', borderRadius: '0' }} />
                        {isTooShort && (
                            <>
                                <span style={{ color: 'RGB(8, 155, 128)', fontSize: '14px', fontFamily: 'Roboto' }}>
